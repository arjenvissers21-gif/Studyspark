...
3. Set `DATABASE_URL`, a long random `AUTH_SECRET`, and `OPENAI_API_KEY` for Production.
...
Never put `OPENAI_API_KEY`, `DATABASE_URL`, or `AUTH_SECRET` in client code or `NEXT_PUBLIC_*` variables.
