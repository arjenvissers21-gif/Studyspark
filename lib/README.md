...
3. Set `DATABASE_URL`, a long random ``, and `OPENAI_API_KEY` for Production.
...
Never put `OPENAI_API_KEY`, `DATABASE_URL`, or `` in client code or `NEXT_PUBLIC_*` variables.
